...
<body class="font-sans text-playtomic-text bg-playtomic-bg antialiased flex flex-col min-h-screen">
    ...
    <nav class="bg-white flex items-center justify-between px-6 lg:px-12 py-5 w-full border-b border-gray-100 shadow-sm sticky top-0 z-50">
        <div class="max-w-[1000px] mx-auto w-full flex items-center justify-between">
            <a href="{{ route('home') }}" class="flex items-center gap-2 text-playtomic-blue font-black text-xl tracking-wider uppercase">
                <i class="bi bi-layers h-6 text-2xl flex items-center"></i> PLAYRESERVE
            </a>
            <a href="{{ route('login') }}" class="text-sm font-bold text-gray-500 hover:text-playtomic-blue transition-colors">Log in instead</a>
        </div>
    </nav>
            ...
            <form method="POST" action="{{ route('register.owner') }}" enctype="multipart/form-data" class="space-y-8">
                ...
                <div class="space-y-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
                            ...
                            <input name="name" type="text" value="{{ old('name') }}" required class="block w-full px-4 py-3 bg-[#f4f5f7] border-transparent text-playtomic-text rounded-xl focus:bg-white focus:outline-none focus:ring-2 focus:ring-playtomic-blue font-medium" placeholder="John Doe">
                        </div>
                        <div>
                            <label class="block text-[12px] uppercase tracking-wide font-black text-gray-400 mb-1.5">Email Address *</label>
                            <input name="email" type="email" value="{{ old('email') }}" required class="block w-full px-4 py-3 bg-[#f4f5f7] border-transparent text-playtomic-text rounded-xl focus:bg-white focus:outline-none focus:ring-2 focus:ring-playtomic-blue font-medium" placeholder="you@example.com">
                        </div>
                        <div>
                            <label class="block text-[12px] uppercase tracking-wide font-black text-gray-400 mb-1.5">Phone Number</label>
                            <input name="phone" type="text" value="{{ old('phone') }}" class="block w-full px-4 py-3 bg-[#f4f5f7] border-transparent text-playtomic-text rounded-xl focus:bg-white focus:outline-none focus:ring-2 focus:ring-playtomic-blue font-medium" placeholder="06XXXXXXXX">
                        </div>
                ...
                <div class="space-y-5 pt-2">
                    ...
                    <div>
                        ...
                        <input name="club_name" type="text" value="{{ old('club_name') }}" required class="block w-full px-4 py-3 bg-[#f4f5f7] border-transparent text-playtomic-text rounded-xl focus:bg-white focus:outline-none focus:ring-2 focus:ring-playtomic-blue font-medium" placeholder="e.g. Sport Center">
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
                            ...
                            <select name="club_city" required class="block w-full px-4 py-3 bg-[#f4f5f7] border-transparent text-playtomic-text rounded-xl focus:bg-white focus:outline-none focus:ring-2 focus:ring-playtomic-blue font-medium appearance-none">
                                ...
                                <option value="Casablanca" {{ old('club_city') == 'Casablanca' ? 'selected' : '' }}>Casablanca</option>
                                <option value="Rabat" {{ old('club_city') == 'Rabat' ? 'selected' : '' }}>Rabat</option>
                                <option value="Marrakech" {{ old('club_city') == 'Marrakech' ? 'selected' : '' }}>Marrakech</option>
                                <option value="Fès" {{ old('club_city') == 'Fès' ? 'selected' : '' }}>Fès</option>
                                <option value="Tanger" {{ old('club_city') == 'Tanger' ? 'selected' : '' }}>Tanger</option>
                                <option value="Agadir" {{ old('club_city') == 'Agadir' ? 'selected' : '' }}>Agadir</option>
                                <option value="Meknès" {{ old('club_city') == 'Meknès' ? 'selected' : '' }}>Meknès</option>
                                <option value="Oujda" {{ old('club_city') == 'Oujda' ? 'selected' : '' }}>Oujda</option>
                            </select>
                        </div>
                        <div>
                            <label class="block text-[12px] uppercase tracking-wide font-black text-gray-400 mb-1.5">Club Phone *</label>
                            <input name="club_phone" type="text" value="{{ old('club_phone') }}" required class="block w-full px-4 py-3 bg-[#f4f5f7] border-transparent text-playtomic-text rounded-xl focus:bg-white focus:outline-none focus:ring-2 focus:ring-playtomic-blue font-medium" placeholder="05XXXXXXXX">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
                            ...
                            <input name="club_address" type="text" value="{{ old('club_address') }}" required class="block w-full px-4 py-3 bg-[#f4f5f7] border-transparent text-playtomic-text rounded-xl focus:bg-white focus:outline-none focus:ring-2 focus:ring-playtomic-blue font-medium" placeholder="123 Boulevard Mohammed V">
                        </div>
                        <div>
                            <label class="block text-[12px] uppercase tracking-wide font-black text-gray-400 mb-1.5">Club Email *</label>
                            <input name="club_email" type="email" value="{{ old('club_email') }}" required class="block w-full px-4 py-3 bg-[#f4f5f7] border-transparent text-playtomic-text rounded-xl focus:bg-white focus:outline-none focus:ring-2 focus:ring-playtomic-blue font-medium" placeholder="contact@club.com">
                        </div>
                    </div>
