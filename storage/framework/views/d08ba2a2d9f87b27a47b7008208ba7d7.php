    ...
    <div class="grid grid-cols-1 lg:grid-cols-5 gap-8 items-start animate-fade-in-up">
        ...
        <div class="lg:col-span-3">
            <div class="bg-white border border-gray-200 rounded-[32px] p-8 shadow-sm relative">
                ...
                <form id="payment-form" method="POST" action="<?php echo e(route('paiement.process', $reservation->id)); ?>" class="space-y-6">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="pt-4">
                        <button id="submit-button" type="submit" class="w-full py-5 bg-playtomic-blue text-white font-black rounded-2xl transition-all shadow-lg shadow-playtomic-blue/30 hover:bg-blue-700 hover:-translate-y-0.5 active:translate-y-0.5 flex items-center justify-center gap-3 text-lg">
                            <span id="button-text">Pay <?php echo e(number_format($reservation->total_price, 0)); ?> DH</span>
                ...
                <div class="space-y-6">
                    <div class="flex items-start gap-4">
                        <div class="w-12 h-12 bg-white rounded-xl shadow-sm flex items-center justify-center text-playtomic-blue text-xl flex-shrink-0 border border-gray-100">
                             ...
                             <?php elseif($reservation->terrain->sport_type == 'basketball'): ?> <i class="bi bi-basket"></i>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <div class="text-base font-bold text-[#0B1526]"><?php echo e(\Carbon\Carbon::parse($reservation->reservation_date)->format('l, d M Y')); ?></div>
                            <div class="text-sm text-gray-500 font-medium"><?php echo e(\Carbon\Carbon::parse($reservation->start_time)->format('H:i')); ?> – <?php echo e(\Carbon\Carbon::parse($reservation->end_time)->format('H:i')); ?></div>
                        </div>
                    </div>
                    ...
                    <div class="pt-6 border-t border-gray-200">
                        <div class="flex justify-between items-center mb-2">
                            ...
                            <span class="text-[#0B1526] font-bold"><?php echo e(number_format($reservation->total_price, 0)); ?> DH</span>
                        </div>
                        ...
                        <div class="flex justify-between items-center bg-white p-5 rounded-2xl border border-gray-100 shadow-sm">
                            ...
                            <span class="text-2xl font-black text-playtomic-blue"><?php echo e(number_format($reservation->total_price, 0)); ?> DH</span>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        const isMock = <?php echo e($isMock ? 'true' : 'false'); ?>;
        const stripeKey = '<?php echo e($stripeKey); ?>'.trim();
        ...
        form.addEventListener('submit', async (event) => {
            ...
            if (isMock) {
                ...
                if (cardNumber.length < 16) {
                    setTimeout(() => {
                        ...
                        buttonText.innerText = 'Pay <?php echo e(number_format($reservation->total_price, 0)); ?> DH';
                    }, 500);
                    return;
                }
            ...
            const { paymentIntent, error } = await stripe.confirmCardPayment('<?php echo e($clientSecret); ?>', {
                payment_method: {
                    card: card,
                    billing_details: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Youcode\Desktop\playreserve\resources\views/paiement/show.blade.php ENDPATH**/ ?>